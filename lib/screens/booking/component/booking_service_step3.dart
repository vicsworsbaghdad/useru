...
class BookingServiceStep3 extends StatefulWidget {
  ...
  BookingServiceStep3({required this.data});
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    if (widget.data.serviceDetail!.appliedCouponData != null) Text(language.lblCoupon, style: secondaryTextStyle(size: 16)) else Text(language.lblCoupon, style: secondaryTextStyle(size: 16)).expand(),
