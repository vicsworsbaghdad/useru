...
class BookingItemComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String buildTimeWidget({required BookingData bookingDetail}) {
      ...
      return TimeOfDay(hour: bookingDetail.booking_slot.validate().splitBefore(':').split(":").first.toInt(), minute: bookingDetail.booking_slot.validate().splitBefore(':').split(":").last.toInt()).format(context);
    }
